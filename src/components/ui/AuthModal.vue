<template>
  ...
  >
    ...
    >
      ...
      <div>
        ...
        <InputText
          ...
          :aria-describedby="
            loginErrors.password ? 'auth-password-error' : undefined
          "
        />
        <p
      ...
      >
        ...
        <RouterLink
          :to="
            loginForm.email
              ? `/verify-email?email=${encodeURIComponent(loginForm.email)}`
              : '/verify-email'
          "
    ...
    <!-- Register form -->
    <form v-else novalidate class="space-y-5" @submit.prevent="registerSubmit">
      <input
      ...
      <div>
        ...
        <InputText
          ...
          :aria-describedby="
            registerErrors.firstName ? 'auth-firstName-error' : undefined
          "
        />
        <p
      ...
      <div>
        ...
        <InputText
          ...
          :aria-describedby="
            registerErrors.lastName ? 'auth-lastName-error' : undefined
          "
        />
        <p
      ...
      <div>
        ...
        <InputText
          ...
          :aria-describedby="
            registerErrors.email ? 'auth-register-email-error' : undefined
          "
        />
        <p
      ...
      <div>
        ...
        <InputText
          ...
          :aria-describedby="
            registerErrors.password ? 'auth-register-password-error' : undefined
          "
        />
        <p
      ...
      <div class="grid grid-cols-[auto_1fr] gap-x-2 gap-y-1">
        <div>
          ...
          <InputText
            ...
            :aria-describedby="
              registerErrors.countryCode ? 'auth-country-code-error' : undefined
            "
          />
          <p
      ...
      <p class="text-sm text-text-secondary">
        After registering you will receive an email with a 6-digit verification
        code.
      </p>
      <div class="flex flex-col gap-2">
        <div class="flex items-start gap-2">
          <Checkbox
            ...
            :invalid="
              Boolean(
                registerErrors.acceptTerms || registerErrors.acceptPrivacy,
              )
            "
            :aria-describedby="
              registerErrors.acceptTerms || registerErrors.acceptPrivacy
                ? 'auth-accept-terms-error'
                : undefined
            "
          />
          <label
            for="auth-accept-terms"
...
const {
  ...
  submitErrorCode: loginSubmitErrorCode,
  submit: loginSubmit,
  reset: loginReset,
